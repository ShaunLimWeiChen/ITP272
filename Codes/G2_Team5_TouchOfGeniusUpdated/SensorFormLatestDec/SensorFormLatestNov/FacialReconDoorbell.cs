...
{
    public partial class FacialReconDoorbell : Form
    {

        //Declaration of variables, vecotrs and haarcascades
        ...
        public FacialReconDoorbell()
        {
            InitializeComponent();
            //Loading Haarascaseds for face detection
        ...
        private void FacialReconDoorbell_Load(object sender, EventArgs e)
        {
